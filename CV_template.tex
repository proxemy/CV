...
% Redefine this path to use your customized data input
\def\DataPath{data_example}
%\def\DataPath{data_real}

% Define custon application recipients.
% The *.tex files have to begin with the set RecpID to be recognized.
%TODO build process parameter
\def\RecpPrefix{recp_prefix} % path and file name to Rrecipient data *.tex file

% personal data
\input{\DataPath/my_data.tex}

% recipient
\input{\DataPath/\RecpPrefix_data.tex}
...
\newcommand{\MySignature}{%
	...
	\bigskip\hspace*{0.6cm}\raisebox{-0.4cm}[1.5cm][0cm]{%
		\includegraphics[height=2cm]{\DataPath/Signature.png}\\
	}\\
	\MyCity{}, \PrettyDate \\
...
\begin{tabularx}{\textwidth}{@{}lX@{}}
	...
	&
	\fbox{\includegraphics[height=\PersonalDataHeight,keepaspectratio]{\DataPath/profile_pic.jpg}}
\end{tabularx}
}
...
\newcommand{\PageFillImage}[1]{%
	\begin{minipage}[b]{\textwidth}
		\centering\fcolorbox{RoyalBlue}{white}{
			\includegraphics[width=\linewidth,height=\RemainingPageHeight,keepaspectratio]{\DataPath/#1}
		}
	\end{minipage}
	\newpage
}%
